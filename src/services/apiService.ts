...
class ApiService {
  ...
  async getAds(): Promise<GetAdsResponse> {
    try {
      const response = await fetch(`${API_BASE_URL}/Ads/GetAds`, {
        method: 'GET',
        headers: this.getHeaders()
      });
